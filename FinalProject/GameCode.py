...
class Shooter(Entity):
    Img = pygame.image.load('shooter.png')
...
class Barrier(Entity):
    Img = pygame.image.load('barrier.png')
    Img = pygame.transform.scale(Img,(57,57))
...
class Sunflower(Entity):
    ...
    Img = pygame.image.load('sunflower.png')
    Img = pygame.transform.scale(Img, (57, 57))
...
def permanent_display(game_over):
    if game_over == False:
        bg = pygame.image.load('LawnEdit.png')
        bg = pygame.transform.scale(bg,(720, 600))
        bgSidewalk = pygame.image.load('LawnSidewalk.png')
